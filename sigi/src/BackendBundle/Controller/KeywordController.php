...
use BackendBundle\Form\KeywordType;
...
class KeywordController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $keywords = $em->getRepository('BackendBundle:Keyword')->findAll();
    ...
    {
        $keyword = new Keyword();
        $form = $this->createForm('BackendBundle\Form\KeywordType', $keyword);
    ...
    {
        $deleteForm = $this->createDeleteForm($keyword);
        $editForm = $this->createForm('BackendBundle\Form\KeywordType', $keyword);
